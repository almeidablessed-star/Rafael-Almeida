...
export const TransactionFormModal: React.FC<TransactionFormModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-end sm:items-center justify-center bg-slate-900/80 backdrop-blur-xs p-0 sm:p-4 overflow-y-auto">
      <div className="w-full max-w-xl bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col animate-slideUp">
        {/* Modal Header */}
        <div className={`px-5 py-4 flex items-center justify-between ${typeDetails.badgeBg}`}>
          <div className="flex items-center gap-2">
            <span className="font-brand font-bold text-lg text-slate-800">
              {editingTransaction
                ? 'Editar Lançamento'
                : type === 'venda'
                ? '🎂 Lançar Novo Pedido'
        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto space-y-4 flex-1">
          ...
          {type === 'venda' && (
            <div className="space-y-4">
              ...
              <div className="bg-pink-50/90 p-4 rounded-3xl border border-pink-200 shadow-2xs space-y-3">
                <div className="flex items-center justify-between border-b border-pink-200/80 pb-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-pink-600 hover:bg-pink-700 text-white rounded-xl text-xs font-bold shadow-2xs flex items-center gap-1 transition-all active:scale-95"
                ...
                {storedCustomers.length > 0 && (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-white border border-pink-300 rounded-xl text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-pink-500"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white border border-pink-300 rounded-xl text-xs font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-pink-500"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-slate-800 mb-1 flex items-center gap-1">
                      <Calendar className="w-3 h-3 text-purple-600" /> Data do Evento
                    </label>
                    <input
                      type="date"
                      value={eventDate}
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-slate-800 mb-1 flex items-center gap-1">
                      <Clock className="w-3 h-3 text-purple-600" /> Horário de Entrega / Retirada
                    </label>
                    <input
                      type="time"
                      value={deliveryTime}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white border border-pink-300 rounded-xl text-xs font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-pink-500"
                    />
                  </div>
              ...
              <div className="space-y-3">
                ...
                {orderItems.map((item, index) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="bg-pink-50/50 p-3.5 rounded-2xl border border-pink-200/90 shadow-2xs space-y-3 relative"
                    >
                      {/* Item Header & Delete */}
                      <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-xl text-xs font-extrabold text-slate-900 focus:outline-none focus:ring-2 focus:ring-pink-500"
                        >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium focus:outline-none focus:ring-2 focus:ring-pink-400"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-bold focus:outline-none focus:ring-2 focus:ring-pink-400"
                            />
                          </div>
                        </div>
                      ) : (
                      ...
                      <div className="pt-2 border-t border-pink-200/80 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-[11px] font-bold text-slate-600">Qtd:</span>
                      ...
                      <div className="bg-white p-2 rounded-xl border border-pink-100 text-[10px] grid grid-cols-4 gap-1 text-center font-semibold text-slate-600">
                        <div title="Reposição de Insumos">
                          <span className="block text-amber-700 font-bold">Reposição</span>
                          <span className="font-extrabold text-slate-900">
                            {formatCurrency(bd.totalReposicao)}
                          </span>
                        </div>
                        <div title="Mão de Obra (Seu Salário)">
                          <span className="block text-purple-700 font-bold">Mão Obra</span>
                          <span className="font-extrabold text-slate-900">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 bg-pink-50 hover:bg-pink-100 text-pink-800 font-brand font-bold text-xs rounded-2xl border-2 border-dashed border-pink-300 transition-all flex items-center justify-center gap-2 active:scale-98 shadow-2xs"
                >
              ...
              <div className="pt-2 border-t border-slate-200 space-y-2">
                ...
                {hasAddons && (
                  <div className="bg-purple-50/70 p-3 rounded-xl border border-purple-200 space-y-2.5 animate-fadeIn">
                    {addons.map((addon, index) => (
                      <div
                        key={addon.id}
                        className="bg-white p-2.5 rounded-xl border border-purple-200/80 shadow-2xs space-y-2"
                      >
                        <div className="flex items-center justify-between">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-2.5 py-1.5 bg-slate-50 border border-slate-300 rounded-lg text-xs font-medium focus:outline-none focus:ring-1 focus:ring-purple-500"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              placeholder="0.00"
                              className="w-full px-2.5 py-1.5 bg-slate-50 border border-slate-300 rounded-lg text-xs font-bold text-slate-900 focus:outline-none focus:ring-1 focus:ring-purple-500"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <button
                      ...
                      className="w-full py-1.5 px-3 bg-white text-purple-700 font-bold text-xs rounded-xl border border-dashed border-purple-300 transition flex items-center justify-center gap-1"
                    >
              ...
              <div className="pt-2 border-t border-slate-200 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-2xl text-sm font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-pink-400"
                  />
                </div>
              ...
              <div className="bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 text-white rounded-3xl p-4 shadow-md space-y-3">
                <div className="flex items-center justify-between border-b border-white/10 pb-2">
                  ...
                  <div className="text-right text-[11px] text-slate-300 font-medium">
                    ...
                    {totalAddonsValue > 0 && (
                      <div className="text-purple-300">+ Adic.: {formatCurrency(totalAddonsValue)}</div>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 text-center text-[10px]">
                  ...
                  <div className="bg-white/10 p-2 rounded-xl">
                    <span className="text-purple-300 font-bold block">Mão de Obra</span>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-3 text-sm bg-slate-50 border border-slate-300 rounded-2xl text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-pink-400 focus:bg-white"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center bg-slate-100 border border-slate-300 rounded-2xl overflow-hidden p-1">
                    <button
                      type="button"
                      onClick={() => handleQuantityChange(quantity - 1)}
                      className="w-10 h-10 rounded-xl bg-white text-slate-700 flex items-center justify-center font-bold hover:bg-slate-200 active:scale-95 transition-all"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-sm bg-slate-50 border border-slate-300 rounded-2xl text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-pink-400 focus:bg-white"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-1 flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-medium text-slate-500">Auto-calculado</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-3 text-lg font-extrabold bg-pink-50/50 border-2 border-pink-300 rounded-2xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:bg-white"
                  />
                </div>
              </div>
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-brand text-base font-bold shadow-lg shadow-pink-200 active:scale-98 transition-all flex items-center justify-center gap-2"
            >
