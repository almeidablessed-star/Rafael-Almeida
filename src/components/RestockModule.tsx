...
export const RestockModule: React.FC<RestockModuleProps> = ({
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fadeIn pb-6">
      ...
      {/* Module Summary Card */}
      <div className="bg-gradient-to-r from-[#C8E6D7] via-[#E5F4F0] to-[#C8E6D7] rounded-2xl p-5 md:p-6 text-[#3E3430] shadow-sm border border-[#C8E6D7]/50">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#E6E1DB] rounded-lg text-xs font-medium text-[#3E3430] focus:outline-none focus:ring-2 focus:ring-[#C8E6D7]/40 shadow-xs"
        />
      </div>
      ...
      <div className="space-y-2.5">
        ...
        {filteredItems.length === 0 ? (
          <div className="bg-white rounded-xl p-8 text-center border border-[#E6E1DB] shadow-xs">
            ...
            <p className="text-sm font-bold text-[#3E3430]">Nenhuma compra cadastrada</p>
          ...
          filteredItems.map((item) => (
            <div
              key={item.id}
              className="bg-white p-4 rounded-lg border border-[#E6E1DB] shadow-xs hover:border-[#C8E6D7]/40 transition-all flex items-center justify-between gap-3"
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-2 text-[11px] text-[#5C5550]">
                  ...
                  {item.supplier && (
                    <span className="flex items-center gap-1 bg-[#E6E1DB]/50 font-medium px-2 py-0.5 rounded-md text-[#3E3430]">
                      <Store className="w-3 h-3 text-[#5C5550]" />
                      {item.supplier}
                    </span>
                  )}
              ...
              <div className="text-right flex flex-col items-end shrink-0">
                ...
                <div className="flex items-center gap-1 mt-1">
                  <button
                    ...
                    className="p-1.5 rounded-lg text-[#5C5550] hover:text-[#3E3430] hover:bg-[#C8E6D7]/20 transition-colors"
                    title="Editar"
                  >
