...
export const SalesModule: React.FC<SalesModuleProps> = ({
  ...
  return (
    <div className="space-y-4 animate-fadeIn pb-6">
      ...
      {/* Module Header Card */}
      <div className="bg-gradient-to-r from-[#E8B4B8] via-[#F5E5E7] to-[#E8B4B8] rounded-3xl p-5 text-[var(--color-brand-900)] shadow-card-hover">
        ...
        {breakdown.totalAReceber > 0 && (
          <div className="mt-3.5 p-3 rounded-3xl bg-[#F5D4A8]/20 backdrop-blur-xs border border-[#F5D4A8]/40 flex items-center justify-between">
        ...
        <button
          ...
          className="mt-4 w-full py-3 px-4 bg-[#F5D4A8] hover:bg-[#C99B6F] text-[var(--color-brand-900)] rounded-3xl font-brand font-bold text-sm shadow-sm active:scale-98 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div className="bg-white rounded-3xl p-4 border border-[#E8B4B8]/30 shadow-2xs space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="bg-[#C8E6D7]/12 p-5 rounded-3xl border-2 border-[#C8E6D7]/70 flex flex-col justify-between relative overflow-hidden shadow-sm">
          ...
          <div className="bg-[#D4C5E2]/12 p-5 rounded-3xl border-2 border-[#D4C5E2]/70 flex flex-col justify-between relative overflow-hidden shadow-sm">
          ...
          <div className="bg-[#B8D4E8]/12 p-5 rounded-3xl border-2 border-[#B8D4E8]/70 flex flex-col justify-between relative overflow-hidden shadow-sm">
          ...
          <div className="md:col-span-3 bg-gradient-to-r from-[#E8B4B8] via-[#F5E5E7] to-[#D4C5E2] p-5 md:p-6 rounded-3xl border-2 border-[#E8B4B8]/60 text-[var(--color-brand-900)] shadow-card-hover relative overflow-hidden">
        ...
        {breakdown.totalPendingCount > 0 && (
          <div className="bg-[#F5D4A8]/20 p-2.5 rounded-3xl border border-[#F5D4A8]/40 text-[#6B5A42] text-[11px] flex items-center gap-2 font-medium">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#E6E1DB] rounded-3xl text-xs font-medium text-[var(--color-brand-900)] focus:outline-none focus:ring-2 focus:ring-[#E8B4B8]/40 shadow-2xs"
        />
      </div>
