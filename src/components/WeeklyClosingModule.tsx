...
export const WeeklyClosingModule: React.FC<WeeklyClosingModuleProps> = ({
  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      <div className="bg-gradient-to-r from-purple-700 via-indigo-700 to-purple-800 rounded-3xl p-5 text-white shadow-md">
        <div className="flex items-center justify-between mb-3">
          ...
          {summary.isCurrentWeek ? (
            <span className="bg-emerald-400 text-emerald-950 font-black text-[10px] px-2.5 py-0.5 rounded-full uppercase tracking-wide shadow-2xs">
              Semana Atual
            </span>
          ) : (
            <button
        ...
        <div className="flex items-center justify-between bg-white/10 backdrop-blur-xs rounded-2xl p-2 border border-white/15">
          <button
        ...
        <button
          ...
          className="mt-3.5 w-full py-2.5 px-4 bg-white hover:bg-purple-50 text-purple-900 rounded-2xl font-brand font-bold text-xs shadow-sm active:scale-98 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-5 border-2 border-emerald-500/80 shadow-xs relative overflow-hidden flex flex-col justify-between">
          <div className="absolute -top-6 -right-6 w-24 h-24 bg-emerald-100/50 rounded-full blur-xl pointer-events-none" />

          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-50 border border-emerald-200 px-2.5 py-1 rounded-full flex items-center gap-1.5">
          ...
          <div className="mt-4 bg-emerald-50 p-2.5 rounded-2xl border border-emerald-100 text-[11px] text-emerald-800 font-semibold flex items-center gap-2">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-5 border-2 border-indigo-200/90 shadow-xs relative overflow-hidden flex flex-col justify-between">
          <div className="absolute -top-6 -right-6 w-24 h-24 bg-indigo-100/50 rounded-full blur-xl pointer-events-none" />

          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-50 border border-indigo-200 px-2.5 py-1 rounded-full flex items-center gap-1.5">
          ...
          <div className="mt-4 bg-indigo-50 p-2.5 rounded-2xl border border-indigo-100 text-[11px] text-indigo-900 font-semibold flex items-center gap-2">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-purple-950 to-slate-900 rounded-3xl p-5 text-white shadow-md">
      ...
      {summary.pendingCount > 0 && (
        <div className="bg-amber-50 rounded-2xl p-4 border-2 border-amber-300 text-amber-950 shadow-2xs space-y-2">
          <div className="flex items-center gap-2">
      ...
      <div className="bg-white rounded-3xl p-4 border border-slate-200/80 shadow-2xs space-y-3">
        ...
        {summary.allSalesDetails.length === 0 ? (
          <div className="text-center py-8 px-4 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
            ...
            <button
              onClick={onOpenAddModal}
              className="mt-3 px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs rounded-xl shadow-2xs transition-all inline-flex items-center gap-1"
            >
            ...
            {summary.allSalesDetails.map((detail) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100">
                      ...
                      <div>
                        {!detail.isPaid ? (
                          ...
                          <button
                            onClick={() => onTogglePaymentStatus(sale)}
                            className="px-2 py-1 rounded-xl bg-slate-100 hover:bg-amber-50 text-slate-600 hover:text-amber-800 border border-slate-200 text-[10px] font-semibold active:scale-95 transition-all flex items-center gap-1"
                          >
                  ...
                  {isExpanded && (
                    <div className="p-3 bg-slate-50 border-t border-slate-200/80 rounded-b-2xl text-xs space-y-2">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-[11px]">
                        ...
                        <div className="bg-white p-2 rounded-xl border border-slate-200">
                          <span className="text-[10px] text-amber-600 font-bold block">Delivery</span>
                      ...
                      <div className="pt-2 border-t border-slate-200 flex flex-wrap items-center justify-between text-[11px] font-bold">
