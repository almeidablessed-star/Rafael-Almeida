  ...
  return (
    <div className="bg-white rounded-lg p-3 border border-pink-100/70 shadow-xs mb-4">
      ...
      {period === 'personalizado' && (
        <div className="mt-3 pt-3 border-t border-neutral-100 grid grid-cols-2 gap-2 animate-fadeIn">
          <div>
            ...
            <input
              ...
              className="w-full px-2.5 py-1.5 bg-slate-50 border border-neutral-200 rounded-xl text-xs font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-pink-300"
            />
          </div>
          <div>
            <label className="block text-[11px] font-semibold text-neutral-500 mb-1">
